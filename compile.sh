...
gcc -g -c qDivLanguage.c -o lib/qDivLanguage.o &
...
# Linux
gcc lib/qDivClient.o lib/qDivAudio.o lib/qDivLanguage.o lib/elements.o lib/glad.o lib/ecdh.o -lglfw -lGL -ldl -lpthread -lm -g -o qDivClient &
gcc lib/qDivServer.o lib/ecdh.o lib/open-simplex-noise.o -lpthread -lm -g -o qDivServer &
# Windows
x86_64-w64-mingw32-gcc lib/qDivClient.exe.o lib/qDivAudio.exe.o lib/qDivLanguage.exe.o lib/elements.exe.o lib/glad.exe.o lib/ecdh.exe.o -lwsock32 -lws2_32 -lglfw3 -lopengl32 -lgdi32 -ldl -lm -lmingw32 -o qDivClient.exe -Wl,--subsystem,windows,-Bstatic -lwinpthread &
